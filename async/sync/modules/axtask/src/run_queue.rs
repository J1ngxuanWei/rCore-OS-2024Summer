...
impl AxRunQueue {
    pub fn new() -> SpinNoIrq<Self> {
        ...
        let gc_task = Arc::new(AxTask::new(Task::new(
            0,
...
impl AxRunQueue {
    ...
    fn switch_to(&mut self, prev_task: CurrentTask, next_task: AxTaskRef) {
        ...
        unsafe {
            let prev_ctx_ptr = prev_task.inner.lock().ctx_mut_ptr();
            let next_ctx_ptr = next_task.inner.lock().ctx_mut_ptr();
